 ...
 * generated in the api.map.jumps package. 
...
public class ObjectFactory {
    ...
    private final static QName _DataTime_QNAME = new QName("", "dataTime");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: api.map.jumps
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "dataTime")
    public JAXBElement<String> createDataTime(String value) {
        return new JAXBElement<String>(_DataTime_QNAME, String.class, null, value);
    }
