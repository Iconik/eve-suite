...
public class SubStringContentProposalProvider implements IContentProposalProvider {
	...
	/**
	 * Construct a SubStringContentProposalProvider whose content proposals are
	 ...
	 *            requested.
	 */
	public SubStringContentProposalProvider(String[] proposals) {
		super();
